...
function script_add_softpang() {

/*<link rel="stylesheet" type="text/css" href="<?php echo esc_url( get_template_directory_uri() ) ; ?>/softpang/css/boostrap.css">*/
 	wp_enqueue_style( 'sp-boostrap-style', get_template_directory_uri() .'/softpang/css/boostrap.css' );
 	wp_enqueue_style( 'sp-softpang-style', get_template_directory_uri() .'/softpang/css/softpang.css' );


 	wp_enqueue_script( 'sp-jquery-script', esc_url( get_template_directory_uri() ) .'/softpang/js/jquery-3.2.1.min.js', array('jquery'), '', truex  );
 	wp_enqueue_script( 'sp-greenSock-script', get_template_directory_uri()  .'/softpang/plugins/greensock/TweenMax.min.js', array('jquery'), '', true  );
 	wp_enqueue_script( 'sp-scrollMagic-script', get_template_directory_uri() .'/softpang/plugins/scrollmagic/ScrollMagic.min.js', array('jquery'), '', true  );

 	wp_enqueue_script( 'sp-custom-script', get_template_directory_uri() .'/softpang/js/elements_custom.js', array('jquery'), '', true  );

} 
add_action( 'wp_enqueue_scripts', 'script_add_softpang' );
