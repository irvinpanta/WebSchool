...
require get_template_directory() . '/inc/customizer/sp-eventos-panel.php';
require get_template_directory() . '/inc/customizer/sp-hitos-panel.php';
require get_template_directory() . '/inc/customizer/sp-equipo-panel.php';
require get_template_directory() . '/inc/customizer/sp-about-panel.php';
require get_template_directory() . '/inc/customizer/sp-treebox-panel.php';
require get_template_directory() . '/inc/customizer/sp-testimonios-panel.php';
require get_template_directory() . '/inc/customizer/sp-footer-panel.php';
