...
if ( ! function_exists( 'scholarship_footer_panel_register' ) ) :
    ...
    /*------------------------------------------------------------------------------------------------------------------------------------*/
        ...
        /*$wp_customize->add_section(
            'text_footer_section',
            array(
                'title'     => esc_html__( 'Text Footer Settings', 'scholarship' ),
                'panel'     => 'scholarship_footer_settings_panel',
                'priority'  => 10,
            )
        );
        ...
        $wp_customize->add_setting('scholarship_footertexto',array(
            'default' => null,
            'sanitize_callback' => 'sanitize_text_field'    
        )); 
        $wp_customize->add_control('scholarship_footertexto',array( 
            'type' => 'text',
            'label' => __('Escriba texto de Pie de Pagina: ','scholarship'),
            'section' => 'text_footer_section',
            'setting' => 'scholarship_footertexto'
        ));*/
